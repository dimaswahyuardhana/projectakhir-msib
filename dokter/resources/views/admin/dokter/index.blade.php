        ...
        <div class="table-responsive text-nowrap">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <td style="width: 100px">
                    <form action="{{route('dokter.destroy',['dokter'=> $dokters->id])}}" method="post">
                    @method('delete')
                    @csrf
                    <div class="btn-group">
                        <a href="{{route('dokter.show',['dokter'=> $dokters->id])}}" class="btn btn-info">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{route('dokter.edit',['dokter'=> $dokters->id])}}" class="btn btn-warning">
