		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<p class="mb-4 pr-5">Kumpulan informasi kesehatan terlengkap dan terpercaya, terdapat fitur pesan obat, chat dokter, dan check-in RS dengan mudah dan tanpa ribetttt</p>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a class="btn btn-danger" href="{{url('/daftar_rs')}}">Check-In Rumah Sakit</a>
					</div>
					<div class="feature-item mb-5 mb-lg-0">
						<div class="feature-icon mb-4">
